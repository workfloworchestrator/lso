...
"""Tests for the LSO Celery worker configuration.

These assert the broker-resilience contract that lets the worker recover after a Redis broker
switch-over (for example a virtual IP moving between Redis nodes) instead of getting stuck until a
manual restart.
"""

from lso.worker import celery
